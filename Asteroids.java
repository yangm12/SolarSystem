/**
 * This class can create a asteroid object that orbits the sun or any planet initialied in the constructor. 
 * It extends AstronomicalObj so that it can use the methods in its parent class. 
 * @author Mandy Yang
 */
public class Asteroids extends AstronomicalObj
{
    private Planet p;
    /**
     * This creates a asteroids object. 
     ...
     */
    public Asteroids(double distance, double angle, int diameter, String col)
    {
	 ...
	 * @param col the colour of this object, as a string. Case insentive. <p>One of: BLACK, BLUE, CYAN, DARK_GRAY, GRAY, GREEN, LIGHT_GRAY, 
	 * MAGENTA, ORANGE, PINK, RED, WHITE, YELLOW. Alternatively, a 24 bit hexadecimal string representation of an RGB colour is also accepted, e.g. "#FF0000"</p>
     * @param p the planet this asteroid will orbit to.
     */
    public Asteroids(double distance, double angle, int diameter, String col, Planet p)
    {
        super(distance, angle, diameter, col);
        this.p = p;
    }
    ...
    public void draw(SolarSystem s){
        s.drawSolarObject(this.getDistance(), 
                                this.getAngle(), 
                                this.getDiameter(), 
                                this.getCol());
    }
    ...
    /**
     * Draws called instance within the SolarSystem s parameter that orbits its own planet.
     * @param s teh solar system called instance is about to be drawn in.
     */
    public void drawAbout(SolarSystem s){
